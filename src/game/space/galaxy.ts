...
export const SECTOR_SIZE = 3900;
export const GALAXY_SPAN = 64;
...
export function sectorDensity(sx: number, sy: number, sz: number): number {
  ...
  const rad = Math.hypot(lx, lz) / half;
  if (rad > 1) return 0;
...
const SPECTRAL: SpectralClass[] = [
  ...
  { name: 'W',  color: 0xc0d8ff, rMin: 5,  rMax: 9,  pMax: 2, w: 0.01 },
  { name: 'L',  color: 0xff8040, rMin: 6,  rMax: 9,  pMax: 2, w: 0.02 },
  { name: 'T',  color: 0xff5e20, rMin: 5,  rMax: 7,  pMax: 1, w: 0.01 },
  { name: 'Y',  color: 0xc06050, rMin: 4,  rMax: 6,  pMax: 0, w: 0.005 },
  { name: 'N',  color: 0xff80a0, rMin: 20, rMax: 32, pMax: 6, w: 0.01 },
  { name: 'D',  color: 0xfffcf0, rMin: 4,  rMax: 7,  pMax: 2, w: 0.01 },
];
