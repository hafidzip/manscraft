...
export function buildBody(): BodyRig {
  ...
  box(torso, 0.46, 0.34, 0.28, 0, 0.0, 0, MATS.vest);
  box(torso, 0.3, 0.36, 0.14, 0, 0.02, 0.21, MATS.vest);
  box(torso, 0.46, 0.1, 0.28, 0, -0.31, 0, MATS.black);
  box(torso, 0.12, 0.1, 0.05, 0, -0.31, -0.15, MATS.tan);
  ...
  box(head, 0.23, 0.08, 0.23, 0, 0.19, 0.005, MATS.black);
  box(head, 0.04, 0.04, 0.04, 0, 0.1, -0.115, MATS.skin);
  ...
  const mkLeg = (side: number) => {
    ...
    box(leg, 0.18, 0.06, 0.08, 0, -0.8, -0.2, MATS.boot);
    box(leg, 0.17, 0.12, 0.2, 0, -0.12, 0.005, MATS.black);
    g.add(leg);
    return leg;
  };
  const legL = mkLeg(-1);
...
function buildHandgun(): WeaponRig {
  ...
  box(gun, 0.03, 0.014, 0.05, 0, -0.024, -0.13, MATS.poly, deg(-6));
  ...
  box(slide, 0.048, 0.012, 0.05, 0, 0.012, 0.076, MATS.black);
  for (let i = 0; i < 4; i++) {
    box(slide, 0.05, 0.018, 0.004, 0, 0.002, 0.058 + i * 0.01, MATS.black);
  }
  box(slide, 0.028, 0.014, 0.02, 0, 0.026, 0.068, MATS.black);
  box(slide, 0.006, 0.005, 0.004, -0.008, 0.026, 0.058, MATS.whiteGlow);
  box(slide, 0.006, 0.005, 0.004, 0.008, 0.026, 0.058, MATS.whiteGlow);
  box(slide, 0.006, 0.016, 0.01, 0, 0.024, -0.092, MATS.black);
  box(slide, 0.005, 0.005, 0.004, 0, 0.028, -0.097, MATS.whiteGlow);
...
function buildSMG(): WeaponRig {
  ...
  box(gun, 0.05, 0.064, 0.3, 0, 0, -0.06, MATS.poly);
  box(gun, 0.054, 0.018, 0.27, 0, 0.041, -0.075, MATS.gun2);
  for (let i = 0; i < 7; i++) box(gun, 0.058, 0.009, 0.014, 0, 0.055, -0.19 + i * 0.045, MATS.black);
  box(gun, 0.012, 0.026, 0.075, 0.029, 0.014, -0.065, MATS.black);
  box(gun, 0.01, 0.018, 0.055, 0.035, 0.012, -0.065, MATS.gun2);
  box(gun, 0.044, 0.044, 0.1, 0, 0.004, -0.25, MATS.black);
  box(gun, 0.02, 0.02, 0.04, 0, 0.004, -0.31, MATS.gun);
  box(gun, 0.046, 0.02, 0.24, 0, -0.036, -0.1, MATS.poly);
  box(gun, 0.04, 0.05, 0.16, 0, -0.005, 0.16, MATS.black);
  box(gun, 0.042, 0.07, 0.03, 0, -0.01, 0.25, MATS.poly);
  box(gun, 0.038, 0.09, 0.045, 0, -0.075, 0.055, MATS.gun, deg(-12));
  for (let i = 0; i < 3; i++) box(gun, 0.041, 0.009, 0.048, 0, -0.05 - i * 0.024, 0.052 + i * 0.006, MATS.black, deg(-12));
  box(gun, 0.044, 0.08, 0.042, 0, -0.075, -0.205, MATS.poly, deg(4));
  box(gun, 0.006, 0.05, 0.006, -0.02, 0.055, -0.29, MATS.black);
  box(gun, 0.006, 0.05, 0.006, 0.02, 0.055, -0.29, MATS.black);
  box(gun, 0.046, 0.007, 0.006, 0, 0.083, -0.29, MATS.black);
  box(gun, 0.006, 0.006, 0.004, 0, 0.06, -0.292, MATS.redGlow);
  box(gun, 0.03, 0.026, 0.04, 0, 0.05, 0.03, MATS.black);
...
function buildRifle(): WeaponRig {
  ...
  box(gun, 0.048, 0.056, 0.17, 0, -0.01, 0.02, MATS.poly);
  box(gun, 0.048, 0.042, 0.36, 0, 0.032, -0.1, MATS.black);
  box(gun, 0.012, 0.026, 0.09, 0.029, 0.034, -0.035, MATS.gun2);
  box(gun, 0.008, 0.034, 0.11, 0.034, 0.032, -0.035, MATS.black);
  box(gun, 0.054, 0.054, 0.24, 0, 0.03, -0.28, MATS.poly);
  box(gun, 0.058, 0.012, 0.2, 0, 0.062, -0.28, MATS.black);
  for (let i = 0; i < 4; i++) box(gun, 0.056, 0.02, 0.03, 0, 0.03, -0.36 + i * 0.055, MATS.black);
  box(gun, 0.022, 0.022, 0.09, 0, 0.032, -0.445, MATS.gun);
  box(gun, 0.034, 0.034, 0.06, 0, 0.032, -0.5, MATS.black);
  ...
  box(gun, 0.03, 0.03, 0.12, 0, -0.012, 0.17, MATS.poly);
  box(gun, 0.038, 0.095, 0.045, 0, -0.085, 0.06, MATS.gun, deg(-14));
  box(gun, 0.008, 0.032, 0.008, 0, -0.052, -0.015, MATS.black);
...
function buildSniper(): WeaponRig {
  ...
  box(gun, 0.054, 0.072, 0.24, 0, 0, -0.02, MATS.olive);
  box(gun, 0.026, 0.026, 0.52, 0, 0.012, -0.4, MATS.black);
  for (let i = 0; i < 5; i++) box(gun, 0.032, 0.008, 0.05, 0, 0.025, -0.28 - i * 0.07, MATS.gun2);
  box(gun, 0.048, 0.048, 0.09, 0, 0.012, -0.68, MATS.black);
  ...
  box(gun, 0.06, 0.06, 0.05, 0, 0.098, -0.17, MATS.black);
  box(gun, 0.056, 0.056, 0.04, 0, 0.098, 0.05, MATS.black);
  box(gun, 0.045, 0.045, 0.005, 0, 0.098, 0.073, MATS.glass);
  box(gun, 0.05, 0.05, 0.004, 0, 0.098, -0.196, MATS.glass);
  box(gun, 0.01, 0.03, 0.03, 0, 0.14, -0.06, MATS.black);
  box(gun, 0.04, 0.018, 0.035, 0.032, 0.105, -0.06, MATS.gun2);
  box(gun, 0.012, 0.05, 0.04, -0.02, 0.06, -0.1, MATS.gun);
  box(gun, 0.012, 0.05, 0.04, 0.02, 0.06, 0.03, MATS.gun);
  box(gun, 0.05, 0.08, 0.32, 0, -0.02, 0.2, MATS.olive);
  box(gun, 0.046, 0.026, 0.16, 0, 0.045, 0.22, MATS.black);
  box(gun, 0.054, 0.1, 0.03, 0, -0.02, 0.37, MATS.poly);
  box(gun, 0.038, 0.095, 0.045, 0, -0.085, 0.07, MATS.poly, deg(-14));
  box(gun, 0.044, 0.03, 0.2, 0, -0.062, -0.16, MATS.olive);
...
function buildBazooka(): WeaponRig {
  ...
  box(gun, 0.072, 0.072, 0.66, 0, 0, -0.04, MATS.warhead);
  box(gun, 0.058, 0.058, 0.5, 0, 0, -0.03, MATS.black);
  box(gun, 0.066, 0.066, 0.45, 0, 0, -0.06, MATS.warhead);
  box(gun, 0.08, 0.08, 0.035, 0, 0, -0.37, MATS.black);
  box(gun, 0.08, 0.08, 0.035, 0, 0, 0.18, MATS.black);
  ...
  box(gun, 0.105, 0.105, 0.012, 0, 0, 0.402, MATS.gun);
  ...
  box(gun, 0.03, 0.03, 0.28, 0, -0.075, -0.1, MATS.wood);
  box(gun, 0.04, 0.05, 0.05, 0, -0.075, -0.2, MATS.black);
