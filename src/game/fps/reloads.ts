...
function handgun(ctx: Ctx): TimelineDef {
  return {
    ...
    tracks: [
      ...
      // magazine in the gun: wobble loose -> fall out
      { node: 'mag', keys: [
        k(0.0, [0, -0.09, 0.052], [deg(-14), 0, 0]),
      ...
      { node: 'maghand', keys: [
        ...
        k(1.18, [0, -0.095, 0.052], [deg(-14), 0, 0], 'snap'),
      ]},
    ...
    events: [
      ...
      // mag seats into the magwell
      { t: 1.18, fn: () => { ctx.sfx('in'); ctx.showMag(); ctx.hideMagHand(); } },
      // palm slap — firm lock
...
function smg(ctx: Ctx): TimelineDef {
  return {
    ...
    events: [
      ...
      { t: 0.9, fn: () => ctx.showMagHand() },
      { t: 1.5, fn: () => ctx.sfx('in') },
      { t: 1.56, fn: () => { ctx.showMag(); ctx.hideMagHand(); } },
...
function sniper(ctx: Ctx): TimelineDef {
  return {
    ...
    events: [
      ...
      { t: 1.0, fn: () => ctx.showMagHand() },
      { t: 1.5, fn: () => ctx.sfx('in') },
      { t: 1.57, fn: () => { ctx.showMag(); ctx.hideMagHand(); } },
...
function bazooka(ctx: Ctx): TimelineDef {
  return {
    ...
    tracks: [
      { node: 'gun', keys: [
        k(0.0, [0, 0, 0], [0, 0, 0]),
        k(0.3, [0.04, -0.02, 0.03], [deg(16), deg(-18), deg(18)], 'out'),
        k(2.2, [0.04, -0.02, 0.03], [deg(16), deg(-18), deg(18)], 'smooth'),
        k(2.7, [0, 0, 0], [0, 0, 0], 'inout'),
      ]},
      { node: 'lhand', keys: [
        k(0.0, [0, -0.11, -0.19], [deg(-90), 0, 0]),
        k(0.3, [0.02, -0.2, -0.05], [deg(-70), 0, 0], 'out'),
        k(0.5, [0.14, -0.3, 0.06], [deg(-60), 0, deg(-20)], 'smooth'),
        k(1.15, [0.02, -0.06, -0.3], [deg(-30), 0, 0], 'out'),
        k(1.45, [0.0, -0.02, -0.38], [deg(-8), 0, 0], 'smooth'),
        k(1.7, [0, -0.01, -0.34], [deg(-8), 0, 0], 'snap'),
        k(1.85, [0, -0.01, -0.35], [deg(-8), 0, deg(20)], 'smooth'),
        k(2.2, [0, -0.1, -0.15], [deg(-60), 0, 0], 'out'),
        k(2.55, [0, -0.11, -0.19], [deg(-90), 0, 0], 'inout'),
      ]},
      { node: 'warheadhand', keys: [
        k(0.5, [0.14, -0.28, 0.05], [deg(30), deg(10), deg(70)]),
        k(1.2, [0.03, -0.02, -0.4], [deg(10), 0, deg(30)], 'out'),
        k(1.5, [0, 0, -0.46], [0, 0, 0], 'smooth'),
        k(1.72, [0, 0, -0.32], [0, 0, 0], 'snap'),
        k(1.86, [0, 0, -0.3], [0, deg(20), 0], 'smooth'),
      ]},
    ],
    events: [
      { t: 0.5, fn: () => { ctx.sfx('grab'); ctx.showWarheadHand(); } },
      { t: 1.72, fn: () => ctx.sfx('in') },
      { t: 1.86, fn: () => { ctx.sfx('twist'); ctx.hideWarheadHand(); ctx.showWarhead(); } },
      { t: 2.0, fn: () => ctx.sfx('slap') },
    ],
  };
}
